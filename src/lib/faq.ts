export const faqs = [
  {
    question: "Does OnBoostify post the exact same text everywhere?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes. OnBoostify supports Bring Your Own Key for OpenAI, Anthropic, and OpenRouter. Your key is encrypted at rest and never sent to the browser.",
  },
  {
