...
//   remote — npx supabase secrets set NEXT_PUBLIC_SITE_URL=https://onboostify.baraklabs.com
const BASE_URL = (Deno.env.get("NEXT_PUBLIC_SITE_URL") ?? "https://onboostify.baraklabs.com").replace(
  /\/+$/,
  "",
);
